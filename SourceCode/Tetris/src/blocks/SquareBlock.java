...
public class SquareBlock extends AbstractShape{

	public SquareBlock(Map<Integer, Integer> currentCollumsHighestRows, SingleBlock[][] currentBlocksOnBoard, Graphics currentTetrisBoardGraphics, HoldPanel holdPanel) {
