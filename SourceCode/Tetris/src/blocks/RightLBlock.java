...
public class RightLBlock extends AbstractShape{

	public RightLBlock(Map<Integer, Integer> currentCollumsHighestRows,SingleBlock[][] currentBlocksOnBoard,Graphics currentTetrisBoardGraphics, HoldPanel holdPanel) {
